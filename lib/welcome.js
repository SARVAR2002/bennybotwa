...
module.exports = welcome = async (benny, event, message) => {
  ...
  try {
	...
	console.log(color('[GROUP]'), color(moment (1000).format('DD/MM/YY HH:mm:ss'), 'yellow'), color('ADA MEMBER MASUK GRUP!!!'), 'red')
	...
	console.log(color('[GROUP]'), color(moment (1000).format('DD/MM/YY HH:mm:ss'), 'yellow'), color('ADA MEMBER KELUAR GRUP!!!'), 'red')
    }}
